      ...
      sidebarLayout(position = "left",
                    ...
                    mainPanel(
                          tabsetPanel(type = "tabs", 
                                      ...
                                      tabPanel("Statistics", p("You can see here a summary of the movement of your Brownian Motion"),
                                               verbatimTextOutput("summary_x"), 
                                               verbatimTextOutput("summary_y"),
                                               p("Whan to see all the details? Here you can see them"),
                                               tableOutput("table")),
